...
public interface UsersMapper {
	...
	PageData findWithDepartmentById(PageData pd);
	...
	List<PageData> listAllUserByDepartmentId(PageData pd);
	 ...
	 * @return
	 */
	PageData listAllDepartmentid();
	
	List<PageData> listAllUserByDepToNull(PageData pd);
	/**
	 * 通过机构id查询用户
	 * @param pd
	 * @return
	 */
	PageData findByDepId(PageData pd);
