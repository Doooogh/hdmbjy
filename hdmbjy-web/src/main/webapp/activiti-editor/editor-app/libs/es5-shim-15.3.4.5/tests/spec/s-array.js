describe('Array', function() {
    ...
    describe('indexOf', function() {
        ...
        it('should use a strict demo', function() {
        ...
        describe('Array-like', function ArrayLike() {
            ...
            it('should use a strict demo (array-like)', function() {
    ...
    describe('splice', function () {
        ...
        it('basic implementation demo 1', function () {
            expect(test.splice(0)).toEqual(a);
        });
        it('basic implementation demo 2', function () {
            test.splice(0, 2);
