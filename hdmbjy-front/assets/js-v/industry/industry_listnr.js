    ...
    methods: {
        ...
        getListType:function(){
        	...
        	$.ajax({
                ...
                type: "GET",
                url: httpurl+'article/lmType',
                data:{lmName:this.LMNAME,tm:new Date().getTime()},
                dataType:'json',
        ...
        getList: function(){
            ...
            $.ajax({
                ...
                type: "POST",
                url: httpurl+'article/listType?showCount='+this.showCount+'&currentPage='+this.currentPage,
                data: {
